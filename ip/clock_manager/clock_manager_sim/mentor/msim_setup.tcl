...
# # End of template
# ----------------------------------------
# If clock_manager is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.11.08.00:32:53
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clock_manager"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_manager.vho"
}
